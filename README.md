...
| runner | n/a | <pre>object({<br>    total_count                      = number<br>    idle_count                       = number<br>    scale_up_non_busy_target_count   = number<br>    scale_down_non_busy_target_count = number<br>    scale_down_max_count             = number<br>    type                             = string<br>    taint_labels                     = bool<br>  })</pre> | n/a | yes |
