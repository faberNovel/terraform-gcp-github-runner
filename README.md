...
| runner | n/a | <pre>object({<br>    total_count  = number<br>    type         = string<br>    taint_labels = bool<br>  })</pre> | n/a | yes |
| scaling | n/a | <pre>object({<br>    scale_up_non_busy_runners_target_count = number<br>    scale_down_non_busy_runners_chunk_size = number<br>    scale_down_schedule                    = string<br>  })</pre> | n/a | yes |
